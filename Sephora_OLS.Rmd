...
To illustrate why the interaction term captures the different effects of skin type on undertone, let's look at the linear equations for predicted values at different levels of `skin_type`:

- For **Combination** skin (baseline group):

\[
\hat{y}_{Combination} = \beta_0 + \beta_1 \cdot \text{skin_complexion} + \beta_4 \cdot \text{undertone}
\]

- For **Dry** skin:

\[
\hat{y}_{Dry} = \beta_0 + \beta_1 \cdot \text{skin_complexion} + \beta_2 + \beta_4 \cdot \text{undertone} + \beta_5 \cdot \text{undertone} = \beta_0 + \beta_1 \cdot \text{skin_complexion} + \beta_2 + (\beta_4 + \beta_5) \cdot \text{undertone}
\]

- For **Oily** skin:

\[
\hat{y}_{Oily} = \beta_0 + \beta_1 \cdot \text{skin_complexion} + \beta_3 + \beta_4 \cdot \text{undertone} + \beta_6 \cdot \text{undertone} = \beta_0 + \beta_1 \cdot \text{skin_complexion} + \beta_3 + (\beta_4 + \beta_6) \cdot \text{undertone}
\]


Interpretation:

- The slope of `undertone` for the **Combination** group is \(\beta_4\).
- The slope of `undertone` for the **Dry** group is \(\beta_4 + \beta_5\).
- The slope of `undertone` for the **Oily** group is \(\beta_4 + \beta_6\).
...
\boxed{
\begin{cases}
\text{slope difference for Dry vs Combination} = \beta_5 \\
\text{slope difference for Oily vs Combination} = \beta_6
\end{cases}
}
\]
