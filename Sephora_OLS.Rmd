...
- Without interaction, the surface formed by the regression model would be a **plane**—flat in all directions.
- With interaction, the product term bends the surface into a **saddle** or **curved manifold**, because the effect of complexion depends on undertone and vice versa.
