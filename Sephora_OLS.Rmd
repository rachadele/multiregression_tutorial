...
Print the first 5 columns of the design matrix for this model using the `model.matrix` function. Look at observation for customer 1. Can you write the the linear equation for this observation in matrix notation using the values of $X$ you see in the design matrix?
