...
Print the design matrix for the continuous interaction model using the `model.matrix` function. 

```{r, answer}
model.matrix(interaction_model2) %>% head()
```
Write out the linear equation for  observation 1 
# References
